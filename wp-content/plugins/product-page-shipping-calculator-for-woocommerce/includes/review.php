...
v1.0.1
*/
if(!class_exists('pisol_ppscw_shipping_calculator_review')){
class pisol_ppscw_shipping_calculator_review{
...
new pisol_ppscw_shipping_calculator_review('Product page shipping calculator plugin', 'product-page-shipping-calculator-for-woocommerce');
}