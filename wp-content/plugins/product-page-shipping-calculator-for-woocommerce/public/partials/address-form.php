...
<form class="pi-ppscw-address-form <?php echo $layout; ?>" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
		<div class="pi-ppscw-address-form-error"></div>
		<div class="pi-address-form-fields">
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<?php
			$countries = WC()->countries->get_shipping_countries();
			$remove_country_field = get_option('pi_ppscw_remove_country_add_form',0);
			?>
		...
		<?php 
		$remove_state = get_option('pi_ppscw_remove_state_add_form',0);
		...
		<?php 
		$remove_city = get_option('pi_ppscw_remove_city_add_form',0);
		...
		<?php 
		$remove_postcode = get_option('pi_ppscw_remove_postcode_add_form',0);
