 ...
 */
class BufferHandler extends \OctolizeShippingCostOnProductPageVendor\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\OctolizeShippingCostOnProductPageVendor\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \OctolizeShippingCostOnProductPageVendor\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
