 ...
 */
abstract class AbstractHandler implements \OctolizeShippingCostOnProductPageVendor\Monolog\Handler\HandlerInterface, \OctolizeShippingCostOnProductPageVendor\Monolog\ResettableInterface
{
    protected $level = \OctolizeShippingCostOnProductPageVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \OctolizeShippingCostOnProductPageVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
    ...
    {
        return new \OctolizeShippingCostOnProductPageVendor\Monolog\Formatter\LineFormatter();
    }
}
