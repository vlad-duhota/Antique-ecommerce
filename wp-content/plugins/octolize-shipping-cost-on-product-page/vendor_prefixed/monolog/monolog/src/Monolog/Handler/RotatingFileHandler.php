 ...
 */
class RotatingFileHandler extends \OctolizeShippingCostOnProductPageVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \OctolizeShippingCostOnProductPageVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \OctolizeShippingCostOnProductPageVendor\Monolog\Utils::canonicalizePath($filename);
