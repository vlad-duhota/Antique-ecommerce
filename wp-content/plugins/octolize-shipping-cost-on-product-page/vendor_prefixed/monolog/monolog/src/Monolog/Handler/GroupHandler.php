 ...
 */
class GroupHandler extends \OctolizeShippingCostOnProductPageVendor\Monolog\Handler\AbstractHandler
{
    protected $handlers;
    /**
    ...
    public function __construct(array $handlers, $bubble = \true)
    {
        foreach ($handlers as $handler) {
            if (!$handler instanceof \OctolizeShippingCostOnProductPageVendor\Monolog\Handler\HandlerInterface) {
