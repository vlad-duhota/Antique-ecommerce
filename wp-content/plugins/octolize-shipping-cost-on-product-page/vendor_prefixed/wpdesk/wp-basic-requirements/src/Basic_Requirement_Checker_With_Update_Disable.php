...
if (!\class_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \OctolizeShippingCostOnProductPageVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
