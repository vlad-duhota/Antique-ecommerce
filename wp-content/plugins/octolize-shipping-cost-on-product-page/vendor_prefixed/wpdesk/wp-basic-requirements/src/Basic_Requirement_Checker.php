...
if (!\interface_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \OctolizeShippingCostOnProductPageVendor\WPDesk_Requirement_Checker
    {
