...
if (!\class_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Tracker')) {
    class WPDesk_Tracker implements \WPDesk_Tracker_Interface
    {
        ...
        private function send_payload_to_wpdesk(array $payload)
        {
            try {
                ...
                return \true;
            } catch (\OctolizeShippingCostOnProductPageVendor\WPDesk_Tracker_Sender_Exception_WpError $e) {
                return \false;
            }
        }
        /**
