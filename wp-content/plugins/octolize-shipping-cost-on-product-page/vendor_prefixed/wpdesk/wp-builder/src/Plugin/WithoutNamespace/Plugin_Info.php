...
if (!\interface_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('OctolizeShippingCostOnProductPageVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \OctolizeShippingCostOnProductPageVendor\WPDesk_Translatable, \OctolizeShippingCostOnProductPageVendor\WPDesk_Buildable, \OctolizeShippingCostOnProductPageVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
