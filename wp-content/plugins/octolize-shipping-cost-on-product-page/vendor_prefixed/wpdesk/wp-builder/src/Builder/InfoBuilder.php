 ...
 */
class InfoBuilder extends \OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\OctolizeShippingCostOnProductPageVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
