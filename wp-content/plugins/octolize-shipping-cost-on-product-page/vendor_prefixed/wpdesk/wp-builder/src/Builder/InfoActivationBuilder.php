...
namespace OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Builder;
...
use OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\OctolizeShippingCostOnProductPageVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\OctolizeShippingCostOnProductPageVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
