...
class Factory
{
    ...
    {
        return new \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\Notice($noticeContent, $noticeType, $isDismissible, $priority);
    }
    /**
    ...
    {
        return new \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\PermanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
