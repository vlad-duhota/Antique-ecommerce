...
namespace OctolizeShippingCostOnProductPageVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'octolize-shipping-cost-on-product-page'),
            $dir
        ), \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'octolize-shipping-cost-on-product-page'),
            $file
        ), \OctolizeShippingCostOnProductPageVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
