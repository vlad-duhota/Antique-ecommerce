...
class Xirki_Control {
	 ...
	 */
	final protected function get_control_class_name( $args ) {
	 ...
	 * Makes sure the xirki_control_types filter is applied
	 * and that the defined classes actually exist.
	 * If a defined class does not exist, it is removed.
	 *
	 * @access private
	 */
	final protected function set_control_types() {
		...
		self::$control_types = apply_filters( 'xirki_control_types', array() );
