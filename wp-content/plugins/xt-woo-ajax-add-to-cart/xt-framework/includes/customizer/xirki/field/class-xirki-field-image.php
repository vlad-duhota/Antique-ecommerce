 ...
 * Field overrides.
 */
class Xirki_Field_Image extends Xirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'xirki' ),
				'change'       => esc_html__( 'Change image', 'xirki' ),
				'default'      => esc_html__( 'Default', 'xirki' ),
				'remove'       => esc_html__( 'Remove', 'xirki' ),
				'placeholder'  => esc_html__( 'No image selected', 'xirki' ),
				'frame_title'  => esc_html__( 'Select image', 'xirki' ),
				'frame_button' => esc_html__( 'Choose image', 'xirki' ),
			)
		);
	}
