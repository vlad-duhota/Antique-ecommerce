...
class Xirki_Modules_Loading {
	...
	public function init() {
		...
		// Allow disabling the custom loader using the xirki_config filter.
	...
	public function add_loader_to_footer() {
		?>
		<div class="xirki-customizer-loading-wrapper">
			<span class="xirki-customizer-loading"></span>
		</div>
		<?php
	}
	...
	public function add_loader_styles_to_header() {
		...
		<style>
			...
			.xirki-customizer-loading-wrapper {
				width: 100%;
				height: 100%;
				position: fixed;
				top: 0;
			...
			body.wp-customizer-unloading .xirki-customizer-loading-wrapper {
				display: block;
				opacity: 1;
			}
			.xirki-customizer-loading-wrapper .xirki-customizer-loading {
				position: absolute;
				width: 60px;
				height: 60px;
				top: 50%;
