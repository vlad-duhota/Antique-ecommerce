...
class Xirki_Modules_Tooltips {
	...
	public function customize_controls_print_footer_scripts() {
		...
		wp_enqueue_script( 'xirki-tooltip', trailingslashit( Xirki::$url ) . 'modules/tooltips/tooltip.js', array( 'jquery' ), XIRKI_VERSION, false );
		wp_localize_script( 'xirki-tooltip', 'xirkiTooltips', $this->tooltips_content );
		wp_enqueue_style( 'xirki-tooltip', trailingslashit( Xirki::$url ) . 'modules/tooltips/tooltip.css', array(), XIRKI_VERSION );
	}
}
