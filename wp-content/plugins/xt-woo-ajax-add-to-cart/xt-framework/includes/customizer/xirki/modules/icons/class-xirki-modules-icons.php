...
class Xirki_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		...
		wp_enqueue_script( 'xirki_panel_and_section_icons', trailingslashit( Xirki::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), XIRKI_VERSION, true );
		wp_localize_script( 'xirki_panel_and_section_icons', 'xirkiIcons', self::$icons );
	}
}
