 ...
 * based on the settings set using the xirki_config filter.
 ...
 */
class Xirki_Modules_Customizer_Styling {
	...
	public function custom_css() {
		...
		.customize-control-xirki-background .background-attachment .buttonset .switch-label,
		.customize-control-xirki-background .background-size .buttonset .switch-label,
		.customize-control-xirki-radio-buttonset .buttonset .switch-label {
			color: <?php echo esc_html( $text_on_back ); ?>;
		}
		...
		.customize-control-xirki-slider input[type=range]::-webkit-slider-thumb {
			background-color:<?php echo esc_html( $accent ); ?>;
		}

		.customize-control-xirki-slider input[type=range]::-moz-range-thumb {
			background-color: <?php echo esc_html( $accent ); ?>;
		}

		.customize-control-xirki-slider input[type=range]::-ms-thumb {
			background-color: <?php echo esc_html( $accent ); ?>;
		}

		.customize-control-xirki-slider input[type=range] {
		...
		.customize-control-xirki-radio-buttonset .buttonset .switch-input:checked + .switch-label,
		.customize-control-xirki-background .background-attachment .buttonset .switch-input:checked + .switch-label,
		.customize-control-xirki-background .background-size .buttonset .switch-input:checked + .switch-label {
			background-color: <?php echo esc_html( $accent ); ?>;
			border-color: <?php echo esc_html( $border_on_accent ); ?>;
			color: <?php echo esc_html( $text_on_accent ); ?>;
		}
