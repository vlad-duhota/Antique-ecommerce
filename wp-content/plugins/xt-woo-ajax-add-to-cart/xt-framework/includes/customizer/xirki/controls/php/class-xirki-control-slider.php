 ...
 */
class Xirki_Control_Slider extends Xirki_Control_Base {
	...
	protected function content_template() {
		...
		<label>
			...
			<div class="wrapper">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span class="screen-reader-text"><?php esc_html_e( 'Reset', 'xirki' ); ?></span></span>
				<span class="value">
