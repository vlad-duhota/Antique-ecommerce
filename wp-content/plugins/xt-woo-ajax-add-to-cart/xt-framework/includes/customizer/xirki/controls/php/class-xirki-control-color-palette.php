 ...
 */
class Xirki_Control_Color_Palette extends Xirki_Control_Base {
	 ...
	 * @var string
	 */
	public $type = 'xirki-color-palette';
	...
	public function to_json() {
		...
		if ( ! isset( $this->json['choices']['colors'] ) || empty( $this->json['choices']['colors'] ) ) {
			$this->json['choices']['colors'] = Xirki_Helper::get_material_design_colors( 'primary' );
		}
