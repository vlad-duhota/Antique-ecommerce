...
list ( $field_id, $class, $no_value, $multiple, $data, $name, $style, $value ) = xtfw_extract( $field, 'id', 'class', 'no_value', 'multiple', 'data', 'name', 'style', 'value' );
...
$default_data = array(
	'action'      => 'xtfw_json_search_terms',
	'placeholder' => __( 'Search Categories', 'xt-framework' ),
	'allow_clear' => false,
	'taxonomy'    => 'category',
	'term_field'  => 'id',
);
...
?>
<div class="xtfw-select2-wrapper">
	<?php
	if ( function_exists( 'xtfw_wp_select2' ) ) {
		xtfw_wp_select2(
			array(
				'id'                => $field_id,
				'name'              => $name,
